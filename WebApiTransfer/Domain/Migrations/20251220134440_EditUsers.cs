    ...
    public partial class EditUsers : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblTransportationStatus", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tblTransportations_tblTransportationStatus_StatusId",
                        column: x => x.StatusId,
                        principalTable: "tblTransportationStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
